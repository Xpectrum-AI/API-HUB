...
{`{
              ...
              <table className="w-full">
                <thead>
                  <tr className="bg-accent/30">
                    ...
                    <th className="text-left px-3 py-2.5 text-sm font-medium">Name</th>
                    <th className="text-left px-3 py-2.5 text-sm font-medium">Value</th>
                    <th className="w-10 px-3 py-2.5"></th>
                  </tr>
                </thead>
                <tbody>
                      ...
                      <td className="px-2 py-1.5 text-center">
                        {headerParams.length > 1 && (
                          <button 
                            ...
                            className="text-red-500 hover:text-red-700 p-1 rounded-md hover:bg-red-50 dark:hover:bg-red-950/30"
                          >
                            <X className="h-4 w-4" />
                          </button>
                        )}
      ...
      <div className="py-4 px-4">
        <div className="flex items-center space-x-2 mb-4">
          ...
          ${responseStatus.code >= 200 && responseStatus.code < 300 
            ...
            <span className={`h-1.5 w-1.5 rounded-full ${responseStatus.code >= 200 && responseStatus.code < 300 ? 'bg-emerald-500' : 'bg-red-500'} inline-block`}></span>
        ...
        <div className="mt-2">
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-2">
              ...
              <span className="px-2.5 py-0.5 bg-emerald-600/20 text-emerald-500 rounded-md text-xs">JSON</span>
            </div>
            <button className="flex items-center gap-2 text-xs text-muted-foreground hover:text-foreground p-1 rounded-md hover:bg-accent/10" onClick={copyToClipboard}>
  ...
  // Add keyboard shortcut to close panel
  useEffect(() => {
  ...
  return (
    <div className="border-l h-screen w-[440px] flex flex-col bg-background">
      <div className="flex items-center gap-4 p-4 border-b">
        <div className="flex items-center flex-1 gap-2">
          ...
          <Input
            ...
            className="flex-1 h-9 bg-background border text-sm"
          />
        </div>
        <div className="flex items-center gap-2">
          <Button 
